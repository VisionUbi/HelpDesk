...
export class CategoryServiceProxy {
     ...
     * @return Success
     */
    getCategoryForEdit(id: number | undefined): Observable<CategoryDto> {
     ...
     * @return Success
     */
    createOrEdit(body: CategoryDto | undefined): Observable<void> {
     ...
     * @return Success
     */
    createCategory(body: CategoryDto | undefined): Observable<void> {
     ...
     * @return Success
     */
    getAllCategorys(description: string | undefined): Observable<CategoryDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Category/GetAllCategorys?";
        if (description === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllCategorys(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllCategorys(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<CategoryDto[]>;
                }
            } else
    ...
    protected processGetAllCategorys(response: HttpResponseBase): Observable<CategoryDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class DepartmentServiceProxy {
     ...
     * @return Success
     */
    getdepartmentForEdit(id: number | undefined): Observable<DepartmentDto> {
    ...
    protected processGetdepartmentForEdit(response: HttpResponseBase): Observable<DepartmentDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    createOrEdit(body: DepartmentDto | undefined): Observable<void> {
     ...
     * @return Success
     */
    getAllDepartments(description: string | undefined): Observable<DepartmentDto[]> {
...
export class TicketServiceProxy {
     ...
     * @return Success
     */
    createCategory(body: TicketDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Ticket/CreateCategory";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    getUserRoleByUserId(userId: number | undefined): Observable<UserRole> {
        let url_ = this.baseUrl + "/api/services/app/Ticket/GetUserRoleByUserId?";
        if (userId === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetUserRoleByUserId(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetUserRoleByUserId(response_ as any);
                } catch (e) {
    ...
    protected processGetUserRoleByUserId(response: HttpResponseBase): Observable<UserRole> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
